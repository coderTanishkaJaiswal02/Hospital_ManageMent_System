...
<div className="mb-2 font-semibold text-gray-700">
  Total Prescriptions: {filteredPrescriptions.length}
      ...
      {/* Desktop List (Suppliers Style) */}
<div className="overflow-auto bg-white rounded-xl shadow hidden md:flex flex-col max-h-[600px]">
  {/* Header */}
  ...
  <div className="flex flex-col">
    {filteredPrescriptions.length > 0 ? (
      filteredPrescriptions.map((p, index) => (
        <div
          key={p.id}
          className="grid grid-cols-7 gap-4 px-6 py-4 border-b hover:bg-gray-50 transition items-center"
        >
          <div>{index + 1}</div>
